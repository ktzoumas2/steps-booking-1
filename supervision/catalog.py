...
COPY: dict[str, dict[str, str]] = {
    ...
    "nav.my_counts": {"de": "Meine Zahlen", "en": "My counts"},
    "nav.all_sessions": {"de": "Alle Termine", "en": "All sessions"},
    "nav.counts_export": {"de": "Zahlen und Export", "en": "Counts and export"},
    ...
    "s5.title": {"de": "Meine Zahlen", "en": "My counts"},
    "s5.sessions_held": {
    ...
    "a2.title": {"de": "Zahlen und Export", "en": "Counts and export"},
